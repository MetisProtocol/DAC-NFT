...
func init() {
	...
	beego.Router("/dac_share/:dac_addr", &controllers.MainController{}, "get:DacShare")
	beego.Router("/profile", &controllers.MainController{}, "get:Profile")
	beego.Router("/share_register/:dac_addr", &controllers.MainController{}, "get:ShareRegister")
	...
	beego.Router("/alert/email-login", &controllers.AlertController{}, "get:EmailLogin")
